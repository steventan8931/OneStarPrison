...
#include "AI/Task_DogGoForFood.h"
...
UTask_DogGoForFood::UTask_DogGoForFood(FObjectInitializer const& ObjectInitializer)
{
	NodeName = TEXT("Dog Go For Food");
}

EBTNodeResult::Type UTask_DogGoForFood::ExecuteTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
